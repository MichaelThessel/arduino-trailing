// constant variables
const int buttonMin = 20;      // minimum switch contact time to start fade cycle (smaller value -> quicker trigger)
const int debounce = 200;      // minimum switch off time before able to retrigger (smaller value -> quicker to trigger after off)
const int delayTime = 10;      // program delay rate (smaller value -> faster runs program)
const int fadeRate = 140;      // rate for exponential fade time (smaller value -> longer fade out time)
